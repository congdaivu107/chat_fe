      ...
      >
        ...
        <Stack p={3} spacing={2} sx={{ maxHeight: '100vh' }}>
          <Stack
            ...
            direction="row"
          >
            <Typography variant="h5">Cuộc trò chuyện</Typography>
                    ...
                    ?.map((el) => {
                      ...
                      const data = {
                        ...
                        name:
                          el.members.length > 2
                            ? sliceName(el.name)
                            : sliceName(friend.displayName),
                        msg: el.message
                          ? Array.isArray(el.message.files) &&
                            el.message.files.length > 0
                            ? 'Ảnh ...'
                            : el.message?.text
                            ? el.message?.text
                            : ''
